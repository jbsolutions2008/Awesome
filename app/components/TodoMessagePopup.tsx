...
export type TodoMessagePopupProps = {
    isVisible?: boolean;
    setVisible?: () => void;
    id?: number,
    title: string;
...
const TodoMessagePopup = (props: TodoMessagePopupProps) => {
        ...
        <Modal
            ...
            <View style={styles.mainContainer}>
                <View style={styles.centerContainerView}>
                    ...
                    <InputText
                        propText={props.todoText}
                        onChangeText={props.setTodoText}
...
export default TodoMessagePopup;
